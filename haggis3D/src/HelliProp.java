...
public class HelliProp {
	...
	public HelliProp(Point3D magoz){
		this.magoz=magoz;
	...
	public void buildShape(double x, double y, double z, double dz)
	{
		...
		xReal[1]=x+dz*5;	yReal[1]=y;					zReal[1]=z;
		xReal[2]=x+dz*5;	yReal[2]=y+dz/4;			zReal[2]=z;
		xReal[3]=x;			yReal[3]=y+dz/4;			zReal[3]=z;
		
		xReal[4]=x; 		yReal[4]=y;					zReal[4]=z+dz;
		xReal[5]=x+dz*5;	yReal[5]=y;					zReal[5]=z+dz;
		xReal[6]=x+dz*5;	yReal[6]=y+dz/4;			zReal[6]=z+dz;
		xReal[7]=x;			yReal[7]=y+dz/4;			zReal[7]=z+dz;

	}
	
	public void copy(HelliProp other){
