...
public class HelliBody {
	...
	public HelliBody(Point3D magoz){
		this.magoz=magoz;
...
//		xReal[0]=x; 		yReal[0]=y+10;		zReal[0]=z;
//		xReal[1]=x+10; 		yReal[1]=y+10;		zReal[1]=z;
//		xReal[2]=x+20;		yReal[2]=y+50;		zReal[2]=z;
//		xReal[3]=x+160;		yReal[3]=y+50;		zReal[3]=z;
//		xReal[4]=x+180;		yReal[4]=y+60;		zReal[4]=z;
//		xReal[5]=x+210; 	yReal[5]=y+80;		zReal[0]=z;
//		xReal[6]=x+220; 	yReal[6]=y+90;		zReal[1]=z;
//		xReal[7]=x+170;		yReal[7]=y+100;		zReal[2]=z;
//		xReal[8]=x+100;		yReal[8]=y+100;		zReal[3]=z;
//		xReal[9]=x+70;		yReal[9]=y+70;		zReal[4]=z;
//		xReal[10]=x+20; 	yReal[10]=y+60;		zReal[0]=z;
//		xReal[11]=x+10; 	yReal[11]=y+80;		zReal[1]=z;
//		xReal[12]=x;		yReal[12]=y+80;		zReal[2]=z;
//		xReal[13]=x+10;		yReal[13]=y+50;		zReal[3]=z;
//		xReal[14]=x;		yReal[14]=y+30;		zReal[4]=z;
		
//		xReal[0]=x+20;      yReal[0]=y+50;  	zReal[0]=z;
//		xReal[1]=x+170;		yReal[1]=y+50;		zReal[1]=z;
//		xReal[2]=x+190;		yReal[2]=y+60;		zReal[2]=z;
//		xReal[3]=x+200; 	yReal[3]=y+80;		zReal[3]=z;
//		xReal[4]=x+210; 	yReal[4]=y+90;		zReal[4]=z;
//		xReal[5]=x+180;		yReal[5]=y+100;		zReal[5]=z;
//		xReal[6]=x+100;		yReal[6]=y+100;		zReal[6]=z;
//		xReal[7]=x+70;		yReal[7]=y+70;		zReal[7]=z;
//		xReal[8]=x+20; 		yReal[8]=y+60;		zReal[8]=z;
//
//		xReal[9]=x+20;      yReal[9]=y+50;  	zReal[9]=z+dz;
//		xReal[10]=x+170;	yReal[10]=y+50;		zReal[10]=z+dz;
//		xReal[11]=x+190;	yReal[11]=y+60;		zReal[11]=z+dz;
//		xReal[12]=x+200; 	yReal[12]=y+80;		zReal[12]=z+dz;
//		xReal[13]=x+210; 	yReal[13]=y+90;		zReal[13]=z+dz;
//		xReal[14]=x+180;	yReal[14]=y+100;	zReal[14]=z+dz;
//		xReal[15]=x+100;	yReal[15]=y+100;	zReal[15]=z+dz;
//		xReal[16]=x+70;		yReal[16]=y+70;		zReal[16]=z+dz;
//		xReal[17]=x+20; 	yReal[17]=y+60;		zReal[17]=z+dz;
		
		//starts from top of head, middle of body 
		xReal[0]=x+dz*2.5;	yReal[0]=y+dz*0.71;		zReal[0]=z+dz/10;
		xReal[1]=x+dz*2.7;	yReal[1]=y+dz*0.85;		zReal[1]=z+dz/10;
		xReal[2]=x+dz*2.85; yReal[2]=y+dz*1.15;		zReal[2]=z;
		xReal[3]=x+dz*2.9; 	yReal[3]=y+dz*1.2;		zReal[3]=z;
		xReal[4]=x+dz*2.7;	yReal[4]=y+dz*1.4;		zReal[4]=z;
		xReal[5]=x+dz*1.5;	yReal[5]=y+dz*1.4;		zReal[5]=z;
		xReal[6]=x+dz*1.15;	yReal[6]=y+dz;			zReal[6]=z+dz/4;
		xReal[7]=x+dz*0.4; 	yReal[7]=y+dz*0.85;		zReal[7]=z+dz/3;
		xReal[8]=x+dz*0.4; 	yReal[8]=y+dz*0.71;  	zReal[8]=z+dz/3;

		xReal[9]=x+dz*2.5;	yReal[9]=y+dz*0.71;		zReal[9]=z+dz-dz/10;
		xReal[10]=x+dz*2.7;	yReal[10]=y+dz*0.85;	zReal[10]=z+dz-dz/10;
		xReal[11]=x+dz*2.85;yReal[11]=y+dz*1.15;	zReal[11]=z+dz;
		xReal[12]=x+dz*2.9; yReal[12]=y+dz*1.2;		zReal[12]=z+dz;
		xReal[13]=x+dz*2.7;	yReal[13]=y+dz*1.4;		zReal[13]=z+dz;
		xReal[14]=x+dz*1.5;	yReal[14]=y+dz*1.4;		zReal[14]=z+dz;
		xReal[15]=x+dz*1.15;yReal[15]=y+dz;			zReal[15]=z+dz-dz/4;
		xReal[16]=x+dz*0.4; yReal[16]=y+dz*0.85;	zReal[16]=z+dz-dz/3;
		xReal[17]=x+dz*0.4;	yReal[17]=y+dz*0.71;  	zReal[17]=z+dz-dz/3;
		
		

	}
	
	public void copy(HelliBody other){
...
//		xGuf[6][3]=xReal[0];	yGuf[6][3]=yReal[0];	zGuf[6][3]=zReal[0];
		...
		for (int i = 0; i < numOfPoints; i++)
		{
			...
			//xGuf[1][i] = xReal[numOfPoints+i];	yGuf[1][i] = yReal[numOfPoints+i];	zGuf[1][i] = zReal[numOfPoints+i];
		}
