...
public class MainPanel3DForStu extends JPanel
{
	...
	ArrayList<Comparable> sortList=new ArrayList<Comparable>();
	int helliWidth = 70;
...
//		.sort(sortList);
		...
		for (Comparable obj : sortList) 
		{
			if (obj instanceof Missile)
				((Missile)obj).convertAndShow(page);
			if (obj instanceof Hellicopter)
				((Hellicopter)obj).convertAndShow(page);
		}
